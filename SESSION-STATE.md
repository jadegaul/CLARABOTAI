...
- 🎓 **COLLEGE UPDATE (Feb 17, 2026)**
  - School: Western Governors University (WGU)
  - Type: Online, competency-based
  - Program: **Bachelor of Science in Business Management**
  - Start Date: February 1, 2026
  - First Class: **Fundamentals for Success in Business** (completed)
  - **Future Goal: MBA after completing BS**
...
- **Sub-Agent Default**: Use sub-agents for multi-step or complex tasks requiring tools — allows me to monitor progress and report back
- **Cron Jobs in Sub-Agents**: Heartbeat checks and all cron jobs should run in sub-agents to avoid blocking main context
